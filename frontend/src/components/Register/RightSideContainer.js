...
const RightSideContainer = ({registerData, handleChange, handleSubmit, error, success}) => {
  return (
    <div className="relative flex gap-2 flex-col h-full justify-center items-center">
        ...
        <span className='text-custom-white text-xl font-semibold whitespace-pre-line tracking-wide'>Welcome to AllPacked!</span>
        <span className='text-custom-white text-lg font-semibold whitespace-pre-line tracking-wide'>Create an account</span>
