...
import { WiSunrise, WiSunset, WiStrongWind, WiRain, WiHumidity, WiThermometer } from 'react-icons/wi'; // Import ikon z React Icons
    ...
    return (
            <div className="flex flex-col w-full h-full bg-custom-light-blue opacity-90 text-custom-white rounded-xl p-5">
                ...
                <div className="grid grid-cols-2 gap-10 h-full m-5">
                    <div className="bg-blue w-full h-full col-start-1 flex flex-col bg-custom-lighter-blue items-center justify-center rounded-xl">
                        <WiSunrise className="text-4xl" />
                        <p className="text-lg mt-2 mb-2">{sunriseTime}</p>
                        <p>Sunrise</p>
                    </div>
                    <div className="bg-blue w-full h-full col-start-2 flex flex-col bg-custom-lighter-blue items-center justify-center rounded-xl">
